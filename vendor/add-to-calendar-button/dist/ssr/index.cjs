...
function dateInTimeZone(timeZone) {
	...
	try {
		...
		const offset = (0, timezones_ical_library.tzlib_get_offset)(timeZone, utcDate, utcTime);
...
function dateIsOverdue(entry) {
	...
	let timestamp;
	if (time !== "") try {
		const offset = (0, timezones_ical_library.tzlib_get_offset)(timeZone, date, time);
		...
		try {
			const offset = (0, timezones_ical_library.tzlib_get_offset)(timeZone, nextDateString, "00:00");
...
//#endregion
exports.atcb_generate_ssr_html = generate_ssr_html;
exports.atcb_generate_ssr_html_async = generate_ssr_html_async;
