	...
	for (let i = loopStart; i <= loopEnd; i++) {
		...
		const timeAddon = (function() {
			...
			if (data.dates[`${i}`].timeZone && data.dates[`${i}`].timeZone !== "") {
				...
				const timeZoneBlock = (0, timezones_ical_library.tzlib_get_ical_block)(timeZone);
...
//#endregion
//#region node_modules/@lit-labs/ssr-dom-shim/lib/css.js
/**
* @license
...
*/
var _globalThis;
var _globalThis$Event;
var _globalThis2;
var _globalThis2$CustomEv;
var _globalThis3;
var _globalThis3$litServe;
...
var isCaptureEventListener = (options) => {
...
var EventTarget = class {
	...
	dispatchEvent(event) {
		...
		Object.defineProperties(event, {
			target: _objectSpread2({ get() {
				var _target;
				return (_target = target) !== null && _target !== void 0 ? _target : tmpTarget;
			} }, enumerableProperty),
			srcElement: _objectSpread2({ get() {
				return event.target;
			} }, enumerableProperty),
			currentTarget: _objectSpread2({ get() {
				return currentTarget;
			} }, enumerableProperty),
			eventPhase: _objectSpread2({ get() {
				return eventPhase;
			} }, enumerableProperty),
			composedPath: _objectSpread2({ value: () => composedPath }, enumerableProperty),
			stopPropagation: _objectSpread2({ value: () => {
				stopPropagation = true;
				originalStopPropagation.call(event);
			} }, enumerableProperty),
			stopImmediatePropagation: _objectSpread2({ value: () => {
...
var DocumentShim = class Document extends NodeShim {
...
var CustomElementRegistry = class {
	...
	define(name, ctor) {
		...
		if (this.__definitions.has(name)) {
			if (process.env.NODE_ENV === "development") console.warn(`'CustomElementRegistry' already has "${name}" defined. This may have been caused by live reload or hot module replacement in which case it can be safely ignored.\nMake sure to test your application with a production build as repeat registrations will throw in production.`);
	...
	async whenDefined(name) {
		var _this = this;
		const definition = _this.__definitions.get(name);
		if (definition) return definition.ctor;
		let withResolvers = _this.__pendingWhenDefineds.get(name);
		if (!withResolvers) {
			withResolvers = promiseWithResolvers();
			_this.__pendingWhenDefineds.set(name, withResolvers);
		}
		return withResolvers.promise;
	}
};
var customElements$1 = new CustomElementRegistry();
...
var c$2 = e$3 || void 0 === t$2.CSSStyleSheet ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((t) => {
	let e = "";
...
var _l$customElements;
var _Symbol;
var _Symbol$metadata;
var _l$litPropertyMetadat;
var _globalThis$HTMLEleme;
var _l$reactiveElementVer;
var { is: h$1, defineProperty: r$1, getOwnPropertyDescriptor: o$3, getOwnPropertyNames: n$1, getOwnPropertySymbols: a$1, getPrototypeOf: c$1 } = Object, l$1 = globalThis;
(_l$customElements = l$1.customElements) !== null && _l$customElements !== void 0 || (l$1.customElements = customElements$1);
var p$1 = l$1.trustedTypes;
var d$1 = p$1 ? p$1.emptyScript : "";
var u$1 = l$1.reactiveElementPolyfillSupport;
var f$1 = (t, s) => t;
var b$1 = {
	toAttribute(t, s) {
		switch (s) {
...
var g$1 = class extends ((_globalThis$HTMLEleme = globalThis.HTMLElement) !== null && _globalThis$HTMLEleme !== void 0 ? _globalThis$HTMLEleme : HTMLElementShimWithRealType) {
	...
	async _$EP() {
		...
		return null != t && await t, !_this.isUpdatePending;
	}
	scheduleUpdate() {
...
//#endregion
//#region node_modules/lit-html/node/lit-html.js
...
var e$2 = s$1 ? s$1.createPolicy("lit-html", { createHTML: (t) => t }) : void 0;
var h = "$lit$";
var o$2 = `lit$${Math.random().toFixed(9).slice(2)}$`;
var n = "?" + o$2;
var r = `<${n}>`;
var l = void 0 === t$1.document ? { createTreeWalker: () => ({}) } : document;
...
i$1._$litElement$ = !0, i$1["finalized"] = !0, (_s$litElementHydrateS = s.litElementHydrateSupport) === null || _s$litElementHydrateS === void 0 || _s$litElementHydrateS.call(s, { LitElement: i$1 });
var o$1 = s.litElementPolyfillSupport;
o$1 === null || o$1 === void 0 || o$1({ LitElement: i$1 });
...
async function validate_timezone(data, msgPrefix, i, msgSuffix) {
	if (!(0, timezones_ical_library.tzlib_get_timezones)().includes(data.dates[`${i}`].timeZone)) throw new Error(msgPrefix + " failed: invalid time zone given" + msgSuffix);
	return true;
}
...
//#endregion
//#region node_modules/lit-html/node/directives/unsafe-html.js
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
function iconTemplate(type) {
	return T`<div class="atcb-icon atcb-icon-${type}" part=${type === "trigger" ? "atcb-button-icon" : "atcb-list-icon"}>${o(icons[`${type}`])}</div>`;
}
...
function dateButtonContentTemplate(data, subEventIn = "all", forceFullDate = false) {
	...
	return T`<div class="atcb-date-btn-left">
    ...
    <div class="atcb-date-btn-right${centerHeadline ? " atcb-date-btn-right-centered" : ""}">
      <div class="atcb-date-btn-details">
        ...
        ${hasLocationLine ? cancelledInfo != "" ? T`<div class="atcb-date-btn-content atcb-date-btn-cancelled">${cancelledInfo}</div>` : T`<div class="atcb-date-btn-content">
                <span class="atcb-date-btn-content-icon">${o(icons["pin"])}</span>
                <span class="atcb-date-btn-content-location">${data.dates[`${subEvent}`].location}</span>
              </div>` : hasDescriptionFallback ? T`<div class="atcb-date-btn-content atcb-date-btn-content-clamped">${data.dates[`${subEvent}`].descriptionHtmlFree}</div>` : A}
        ${fullTimeInfo.length > 0 || data.recurrence != null && data.recurrence != "" ? T`<div class="atcb-date-btn-content">
              <span class="atcb-date-btn-content-icon">${o(icons["clock"])}</span>
              <span class="atcb-date-btn-content-text">
                ${fullTimeInfo.map((block) => T`<span>${block}</span>`)}${data.recurrence != null && data.recurrence != "" ? T`<span>${o(recurringString)}</span>` : A}
              </span>
            </div>` : A}
      </div>
      <div class="atcb-date-btn-hover">${o(hoverText)}</div>
    </div>
    ${!data.hideCheckmark && data.dates[`${subEvent}`].status !== "cancelled" ? T`<div class="atcb-checkmark">${o(icons["checkmark"])}</div>` : A}
    ${cancelledInfo === "" && (!data.dates[`${subEvent}`].overdue || data.pastDateHandling === "none") ? T`<div class="atcb-date-btn-plus">${o(icons["plus"])}</div>` : A}`;
}
function buttonTemplate(host, data) {
	...
	return T`${optionSplit.map((option, index) => {
		...
		return T`<div class="atcb-button-wrapper${data.rtl ? " atcb-rtl" : ""}" part="atcb-button-wrapper">
      <button
        type="button"
      ...
      >
        ...
        ${!isDate && !data.hideIconButton ? iconTemplate(contentType === "trigger" ? "trigger" : option) : A}${!isDate && showText ? T`<span class="atcb-text" part=${contentType === "trigger" ? "atcb-button-text" : "atcb-list-text"}>${text}</span>` : A}
        ${!isDate && contentType === "trigger" && !oneOption && !data.buttonsList && !data.hideTextLabelButton ? T`<div class="atcb-chevron" part="atcb-button-chevron">${o(icons["chevron"])}</div>` : A}
        ${!oneOption ? T`<div class="atcb-dropdown-anchor"></div>` : A}
        ${!data.hideCheckmark && !data.hideTextLabelButton && !data.buttonsList && !data.disabled && !data.allCancelled ? T`<div class="atcb-checkmark">${o(icons["checkmark"])}</div>` : A}
      </button>
    </div>`;
	})}`;
}
...
function renderDateButtonContent(data, parent, subEventIn = "all", oneOption = false, forceFullDate = false) {
	...
	B(dateButtonContentTemplate(data, subEventIn, forceFullDate), parent);
...
function renderButton(host, container, data) {
	B(buttonTemplate(host, data), container);
...
if (isBrowser()) {
	...
	class AddToCalendarButton extends i$1 {
		constructor() {
			super();
		...
		render() {
			...
			return T`<div class="atcb-initialized atcb-hidden">${(_this$_buttonTemplate = this._buttonTemplate) !== null && _this$_buttonTemplate !== void 0 ? _this$_buttonTemplate : A}</div>`;
		}
		connectedCallback() {
...
//#endregion
exports.atcb_action = atcb_action;
exports.atcb_decorate_data_dates = decorate_data_dates;
exports.atcb_generate_timestring = generate_timestring;
exports.atcb_generate_ty = generate_ty;
exports.atcb_register_locale = register_locale;
exports.atcb_register_style = register_style;
exports.cssStyles = atcbCssTemplate;
